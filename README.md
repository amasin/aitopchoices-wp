...
This plugin is designed to work standalone without the traditional WordPress plugin directory structure.

1. Clone or download this repository
2. The plugin files are at the root level (no wp-content/plugins folder needed)
3. When activated in WordPress, the plugin will automatically:
